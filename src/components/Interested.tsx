        ...
        <div className={style.wrapper}>
          ...
          <div className={style.details}>
            ...
            <ul className={style.list}>
              <li>
                Create a fullstack website with custom backend, front end and
                database(MongoDB & SQl).
              </li>
              <li>
                Create custom features and pages for your react.js and next.js
                app.
              </li>
              <li>
                Implementing UI/UX dsigns with high quality screen-resposive.
              </li>
            </ul>
          </div>
          <div>
