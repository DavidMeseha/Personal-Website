...
export async function getStaticProps(ctx) {
  ...
  let projects = [
    ...
    {
      title: 'Laptops Shop',
      technologies: 'A Laptops shop created with Next.js, React.js and mongodb, displaying products, getting data via SSR and implemnting the Auth to the website',
